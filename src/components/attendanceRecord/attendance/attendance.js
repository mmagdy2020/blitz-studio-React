    ...
    return (
      <div className="container">
        ...
        <div className="users">
          ...
          {/* content */}
          <div className="user-attendance-content">
            <div className="user-attendance">
              <div className="user-attendance-item">
                <LineProgress user={user} caption='Bachata' attendance={attendance} />
              </div>
            ...
            <div className="user-attendance">
              <div className="user-attendance-item">
                <LineProgress user={user} caption='Salsa' attendance={attendance} />
