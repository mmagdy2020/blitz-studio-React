        ...
        {this.props.class ?
          <div id="createSeries">
            <div className="form-group">
              ...
              <center>
                <button onClick={() => { this.onCreateNextWeekClass() }} className="btn btn-outline-primary">Save, create another</button>
                <br />
                <button onClick={() => { this.onCreateNextWeekClass() }} className="btn btn-outline-success">Save, exsit</button>
              </center>
              <br />
            </div>
          </div> : <div> hi </div>
